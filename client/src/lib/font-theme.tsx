...
export const fontThemes: FontTheme[] = [
  ...
  },
  {
    ...
    sample: 'Aa',
    vars: {
      // Ubuntu system font (Linux) + web fallback via Google Fonts
      fontUi: '"Ubuntu", "Segoe UI", system-ui, sans-serif',
      fontSans: '"Ubuntu", "Segoe UI", system-ui, sans-serif',
      fontSerif: '"Ubuntu", Georgia, serif',
      fontMono: '"Ubuntu Mono", "Courier New", monospace',
      fontScale: '1.02',
  ...
  },
  {
    ...
    vars: {
      ...
      fontSerif: '"Courier New", "Courier", serif',
